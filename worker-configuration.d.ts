/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9266f799d772034be107eac0e39ac6cb)
// Runtime types generated with workerd@1.20260721.1 2026-07-23 nodejs_compat
interface __BaseEnv_Env {
	XIAOFLOW_API_URL: "https://api.xiaoflow.com";
	MCP_SESSION: DurableObjectNamespace<import("./src/index").McpSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "McpSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "XIAOFLOW_API_URL">> {}
}
